    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                'image', models.ImageField(blank=True, null=True, upload_to='users_images', verbose_name='Фотография')),
            ...
            fields=[
                ('user',
                 models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False,
                                      to='users.user', verbose_name='Профиль пользователя')),
                ...
                ('langs', models.CharField(blank=True, default='RU', max_length=100, verbose_name='Язык')),
            ],
        ),
    ]
